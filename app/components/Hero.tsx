      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Transform your ideas into beautiful, professional-quality images using cutting-edge artificial intelligence. 
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-200">
              <div className="aspect-video bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 rounded-xl flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="text-lg font-semibold">AI-Generated Masterpiece</p>
                  <p className="text-sm opacity-90">Your imagination, brought to life</p>
                </div>
              </div>
            </div>
